        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <a href="{{ route('dashboard.courses.show', $course) }}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage
                        Courses</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-5 mt-2">
                    ...
                    @forelse ($students as $student)
                        <div
                            ...
                            @elseif($student->status == 'Not Started')
                                <div class="flex items-center gap-[14px]">
                                    <p
                                        class="p-[6px_10px] rounded-[10px] bg-indigo-950 font-bold text-xs text-white outline-indigo-950 outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">
                                        Not Started</p>
                                </div>
                    ...
                    @empty
                        <p>
                            Belum ada student di kelas ini.
                        </p>
                    @endforelse
